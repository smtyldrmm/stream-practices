...
import com.cydeo.stream_practice.service.RegionService;
...
@Service
public abstract class RegionServiceImpl extends CrudServiceImpl<Region, Long> implements RegionService {
   ...
   public List<Region> createAllRegion (List<Region> list) {
