...
import com.cydeo.stream_practice.service.CountryService;
...
@Service
public abstract class CountryServiceImpl extends CrudServiceImpl<Country, String> implements CountryService {
     ...
     */
    @Override
    public List<Country> createAllCountry(List<Country> list) {
