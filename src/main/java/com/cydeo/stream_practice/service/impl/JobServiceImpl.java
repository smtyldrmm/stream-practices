...
import com.cydeo.stream_practice.model.Job;
import com.cydeo.stream_practice.service.JobService;
...
@Service
public abstract class JobServiceImpl extends CrudServiceImpl<Job, String> implements JobService {
