...
import com.cydeo.stream_practice.service.DepartmentService;
...
@Service
public abstract class DepartmentServiceImpl extends CrudServiceImpl<Department, Long> implements DepartmentService {
    ...
    @Override
    public List<Department> createAllDepartment(List<Department> list) {
